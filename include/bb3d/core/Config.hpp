...
namespace bb3d {
    ...
    /** @brief Mode de picking (sélection d'objets à la souris). */
    enum class PickingMode { None, PhysicsRaycast, ColorPicking };

    NLOHMANN_JSON_SERIALIZE_ENUM(PickingMode, {
        {PickingMode::None, "none"},
        {PickingMode::PhysicsRaycast, "physics_raycast"},
        {PickingMode::ColorPicking, "color_picking"}
    })
    ...
    struct EngineConfig {
        ...
        EngineConfig& enablePicking(PickingMode m) { modules.setPicking(m); return *this; }
