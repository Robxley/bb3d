# [TASK-CSM] : Plan d'Amélioration des Cascaded Shadow Maps (CSM)

- **Statut :** IN PROGRESS
- **Auteur / Implémenteur :** @dev
- **Reviewer(s) :** @agent
- **Branche Git :** `main`
...
## Grille de Revue & Checkpoints

### 🛠️ Checkpoints de l'Implémenteur
- [ ] **Tests :** Tests unitaires validés (`ctest -R test_shadows`).
- [ ] **Standards C++ (`cpp-pro`) :** Zéro allocation dynamique dans la passe d'ombres, passage par `std::span`.
- [ ] **Standards Vulkan (`vulkan-cpp`) :** Barrières `DependencyInfo`, formats de depth conformes, sampler ClampToBorder.
- [ ] **Build :** Zéro warning de compilation.

### 🔍 Checkpoints des Reviewers
- [ ] **Qualité visuelle :** Pas de shadow acne ni de coupure visible entre cascades.
- [ ] **Validation Layers :** 0 erreur Khronos validation.
- [ ] **Décision :** [ ] APPROVED | [ ] CHANGES REQUESTED
- [ ] **Historique :** 1 entrée compacte consignée dans `tasks/HISTORY.md`.

---

## Journal des Échanges
- *2026-09-17* - **@dev** : Initialisation du plan et stabilisation des matrices de projection de la lumière.