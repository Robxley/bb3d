...
int main() {
    ...
    try {
        ...
        if (!texture) {
            ...
            texture = resources.load<bb3d::Texture>("assets/textures/Bricks092_1K-JPG_Color.jpg");
        }
        ...
        bb3d::GraphicsPipeline pipeline(context, swapChain, vert, frag, config, {dsl0, dsl1}, {pcr});
